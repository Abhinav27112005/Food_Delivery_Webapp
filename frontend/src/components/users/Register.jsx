...
const Register = () => {
  ...
  const {isAuthenticated,error,loading}=useSelector((state)=>state.auth);//need to send the data to the server
  ...
  const submitHandler=(e)=>{
    ...
    formData.set("name",name);//{name:Rahul,password:password}
